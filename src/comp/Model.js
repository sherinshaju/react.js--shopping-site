                  ...
                  <div className="modal-body">
                      <div className="row">
                          ...
                          <div className="col-md-6 product_content">
                              <h4>Product Id: <span>{this.props.name.id}</span></h4>
                              ...
                              <h3 className="cost"><span className="glyphicon glyphicon-usd"></span> {this.props.name.offer} <small className="pre-cost"><span className="glyphicon glyphicon-usd"></span> {this.props.name.price}</small></h3>
                              <div className="row">
                              ...
                              <div className="btn-ground">
                                  <button type="button" onClick = {this.props.count} className="btn btn-primary mr-3"><span className="glyphicon glyphicon-shopping-cart"></span> Add To Cart</button>
